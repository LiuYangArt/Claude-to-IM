...
export type 技能名称 = 'project-overview' | 'code-search' | 'bug-diagnosis' | 'issue-draft' | 'support-answer';
...
function 是支持的技能名称(名称: string): 名称 is 技能名称 {
  return ['project-overview', 'code-search', 'bug-diagnosis', 'issue-draft', 'support-answer'].includes(名称);
}
